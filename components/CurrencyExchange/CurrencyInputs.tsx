...
export default function CurrencyInputs({symbols}: CurrencyInputsProps) {
    ...
    return (
        <>
            ...
            <StyledButton onClick={handleExchange}>
                Exchange
            </StyledButton>
            ...
            {error &&
                <ResultWrapper>
                    <MessageWrapper>
                        <div>
                            <h2> Input data has error, please provide an amount, and the 2 currencies to exchange
                                from-to </h2></div>
            ...
            {exchanged &&
                <ResultWrapper>
                    <MessageWrapper>
                        <div>
                            <h2> {`${amount} ${actualCurrency} is equivalent to ${exchanged} ${desireCurrency}`} </h2>
                            <h3> {`The Conversion Rate is ${conversionRate} ${desireCurrency} per 1 ${actualCurrency}`} </h3>
                        </div>
